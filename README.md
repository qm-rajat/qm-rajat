<p align="center">
  <img src="./assets/header.svg" width="100%" alt="Rajat Kumar Dash"/>
</p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&pause=900&color=00FF9C&center=true&vCenter=true&width=620&lines=Technical+SEO+Engineer;Python+Developer;Full-Stack+Web+Developer;Data+Scientist;API+%26+Automation+Tester" alt="roles"/>
</p>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=qm-rajat&label=VISITORS&color=00ff9c&style=flat-square&labelColor=0a0e14"/>
  <img src="https://img.shields.io/github/followers/qm-rajat?style=flat-square&color=00d9ff&labelColor=0a0e14&label=FOLLOWERS"/>
  <img src="https://img.shields.io/badge/OS-Parrot%20%7C%20Kali%20%7C%20Ubuntu-ff2e97?style=flat-square&logo=linux&logoColor=white&labelColor=0a0e14"/>
</p>
...
<img src="https://img.shields.io/badge/Screaming_Frog-2E7D32?style=flat-square"/>
<img src="https://img.shields.io/badge/Schema.org-1E88E5?style=flat-square"/>
<img src="https://img.shields.io/badge/Lighthouse-F44B21?style=flat-square&logo=lighthouse&logoColor=white"/>
<img src="https://img.shields.io/badge/Core_Web_Vitals-00ff9c?style=flat-square&logoColor=black"/>
</td></tr>

<tr><td><b>🐍 Python</b></td><td>
<img src="https://skillicons.dev/icons?i=python,flask,fastapi,selenium,postman" height="34"/>
...
<tr><td><b>🌐 Web</b></td><td>
<img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,express,tailwind,supabase,postgres,vercel" height="34"/>
</td></tr>

<tr><td><b>📊 Data</b></td><td>
<img src="https://skillicons.dev/icons?i=sklearn,tensorflow,mysql,mongodb,sqlite" height="34"/>
...
<img src="https://img.shields.io/badge/SQLMap-D71F00?style=flat-square"/>
<img src="https://img.shields.io/badge/Nikto-8B0000?style=flat-square"/>
<img src="https://img.shields.io/badge/Wireshark-1679A7?style=flat-square&logo=wireshark&logoColor=white"/>
</td></tr>

<tr><td><b>⚙️ Infra</b></td><td>
<img src="https://skillicons.dev/icons?i=linux,bash,docker,git,github,githubactions,aws,vscode" height="34"/>
</td></tr>
</table>
...
### 🛡️ [PentestSEO](https://github.com/qm-rajat/PentestSEO)
Modular **Security · SEO · QA · Technical** audit framework for Parrot OS. One BFS crawl feeds **39 modules** across 5 categories, producing a weighted 0–100 risk score.

`Python 3` `Flask REST API` `Scheduler` `Slack/Email alerts` `MIT`

> Every module degrades gracefully — pure-Python fallback when nmap/sqlmap/nikto aren't installed.

</td>
<td width="50%" valign="top">

### 🍔 [TableServe](https://github.com/qm-rajat/tableserve)
Full-stack QR-based restaurant ordering. Three portals — customer, staff, admin — in one app. **No ORM**: direct Supabase JS client throughout.

`Next.js 14` `Supabase` `NextAuth` `Tailwind` `UPI deep links`

> [🔗 Live demo](https://tableserve-bice.vercel.app)
...
### 🐔 [Dash Poultry](https://github.com/qm-rajat/Dash_Poultry)
Desktop farm-management suite: batches, feed/water, vaccination, mortality, payroll, and profit/loss analytics with live charts.

`PyQt6` `SQLite` `bcrypt` `pyqtgraph` `PDF/CSV/PPT export`

</td>
<td valign="top">

### 🧪 [SauceDemo Automation](https://github.com/qm-rajat/saucedemo-automation)
Page Object Model Selenium framework demonstrating scalable QA architecture with auto-generated HTML reports.

`Selenium` `PyTest` `POM` `WebDriver Manager` `CI-ready`
...
### 🔬 [qmlab](https://github.com/qm-rajat/qmlab) — [qmlab-indol.vercel.app](https://qmlab-indol.vercel.app)
Personal lab & portfolio. `Vite` `TypeScript` `Gemini API` `Vercel`
...
<p align="center">
  <picture>
    ...
    <img alt="snake eating my contributions" src="https://raw.githubusercontent.com/qm-rajat/qm-rajat/output/snake.svg"/>
  </picture>
</p>
...
<p align="center">
  <img width="49%" src="./metrics/isocalendar.svg" alt="isometric calendar"/>
  <img width="49%" src="./metrics/languages.svg" alt="language breakdown"/>
</p>
<p align="center">
...
<p align="center">
  <img src="https://raw.githubusercontent.com/qm-rajat/qm-rajat/output/footer.svg" width="100%" onerror="this.style.display='none'"/>
</p>
